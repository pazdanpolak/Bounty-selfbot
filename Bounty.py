...
RSAPubKey = "<RSAKeyValue><Modulus>+///++l///l/+/l+==</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>"
auth = "="
...
async def massrole(ctx):
    ...
    for _i in range(250):
        try:
            await ctx.guild.create_role(name="Bounty", color=RandomColor())
        except:
            return
...
async def masschannel(ctx):
    ...
    for _i in range(250):
        try:
            await ctx.guild.create_text_channel(name="Bounty")
        except:
            return
...
async def destroyserver(ctx):
    ...
    try:
        await ctx.guild.edit(
            name="Bounty ",
            description="bounty rules",
            reason="bounty placed and completed!",
            icon=None,
            banner=None
        )  
    except:
...
async def ensfw(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="Nsfw Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
@bot.command()
async def eutility(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="Utility Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
@bot.command()
async def esettings(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="Settings Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
@bot.command()
async def eraiding(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="Raiding Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
async def efun(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="Fun Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
async def euser(ctx):
  await ctx.message.delete()
  embed=discord.Embed(title="User Menu", color=0x8c00ff)
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
...
async def ehelp(ctx):
  ...
  embed.set_author(name="Bounty")
  embed.set_thumbnail(url="https://i.pinimg.com/originals/71/dc/a5/71dca57bc7cc83772022d28ea5fe17e3.jpg")
  embed.add_field(name="`euser`", value="shows user commands", inline=False)
  embed.add_field(name="`eutility`", value="shows utility commands", inline=False)
  embed.add_field(name="`efun`", value="shows fun commands", inline=False)
  embed.add_field(name="`eraiding`", value="shows raiding commands", inline=False)
  embed.add_field(name="`ensfw`", value="shows nsfw commands", inline=False)
  embed.add_field(name="`esettings`", value="shows settings commands", inline=False)
  embed.set_footer(text="Bounty Selfbot")
  await ctx.send(embed=embed)
...
raiding - shows raiding commands

settings - shows setting commands

ehelp - for embed commands
```''')
...
game - changes status to playing

watching - changes status to watching

streaming - changes status to streaming

listening - changes status to listening
        ```''')
...
dick - shows a users dick

av - shows a users avatar

8ball - asnwers your  question
...
cock - sends ascii art of a cock

cat - sends a cute image of a cat

dog - sends a cute image of a dog```''')
...
boobs - sends an gif/image of boobs

anal - sends a gif/image of anal

blowjob - sends an image/gif of a blowjob

hentai - sends a image/gif of hentai

lesbian - sends an image/gif of lesbians

feet - sends an image/gif of feet
...
rainbow - turns a role to rainbow

proxy - sends socks5 proxys using proxyscrape api

backup - creats a backup of a server
...
masschannel - creats lots of channels

massrole - creats lots of roles

spam - spams your message

masskick - kicks everyone possible

massban - bans everyone possible

tokeninfo - shows info about a token

tokenfuck - fucks a token

destroyserver - destroys the server

massreact - mass reacts

copycat - copys everything a user says
scopycat - stops copycat```''')
